...
type VerificationTokenRepository interface {
	...
	StorePasswordResetToken(ctx context.Context, authID string, token string, expireIn time.Duration) error
	...
	StoreActivationToken(ctx context.Context, authID string, token string, expireIn time.Duration) error
